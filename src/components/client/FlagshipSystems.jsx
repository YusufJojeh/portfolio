...
import { flagshipSystems } from '@/lib/data/portfolio';
import {
  Rocket,
  Sparkles,
  Building2,
      ...
      <div className="container-custom">
        ...
        >
          {flagshipSystems.map((system, index) => {
            ...
            const systemTitle = t(`flagship.systems.${systemKey}.title`);
            const systemType = t(`flagship.systems.${systemKey}.type`);
            const systemDescription = t(`flagship.systems.${systemKey}.description`);
            const systemAiFeatures = t.raw(`flagship.systems.${systemKey}.aiFeatures`) || [];
            const systemRole = t(`flagship.systems.${systemKey}.role`);
            const systemHighlights = t.raw(`flagship.systems.${systemKey}.highlights`) || [];
            ...
            >
              ...
              <div className="mb-4">
                ...
                <ul className="space-y-1">
                  {systemAiFeatures.map((feature, idx) => (
