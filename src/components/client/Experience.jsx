          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {experiences.map((experience, index) => {
                const expKey = `exp${experience.id}`;
                const expTitle = t(`experience.list.${expKey}.title`);
                const expCompany = t(`experience.list.${expKey}.company`);
                const expLocation = t(`experience.list.${expKey}.location`);
                const expPeriod = t(`experience.list.${expKey}.period`);
                const expDescription = t.raw(`experience.list.${expKey}.description`) || [];
                  ...
                  <div className={`ml-12 md:ml-0 md:w-5/12 ${
                    ...
                    >
                      ...
                      <div className="space-y-3 mb-4">
                        {expDescription.map((item, itemIndex) => (
                          <motion.div
                            key={itemIndex}
            ...
            <div className="glass-card p-8 max-w-4xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-slate-600 dark:text-slate-400">{t('experience.yearsExp')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">
                    3+
                  </div>
                  <div className="text-slate-600 dark:text-slate-400">{t('experience.yearsDev')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">
                    150+
                  </div>
                  <div className="text-slate-600 dark:text-slate-400">{t('experience.tutoringHours')}</div>
                </div>
              </div>
            </div>
          </motion.div>
